        ...
        <div className="about-grid">
          <article className="panel about-copy">
            <p>
              ...
              clean, responsive, and functional websites. I enjoy bringing ideas
              to life through modern tools like React and JavaScript.
            </p>
            <p>
              I’m currently learning software engineering and always looking for
              ways to improve and grow. Outside of coding, I like working out,
              exploring tech, and staying consistent with my goals.
            </p>
          ...
          <div className="detail-stack">
            ...
            <article className="panel detail-panel">
              ...
              <p>
                <BookOpen size={14} /> Exploring tech, working out, and keeping
                momentum.
              </p>
            </article>
          </div>
