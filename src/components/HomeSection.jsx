...
export default function HomeSection() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-blue-50 px-4 md:px-8 pt-11"
    >
      {/* Card Container */}
      <div className=" rounded-2xl shadow-lg max-w-6xl w-full flex flex-col md:flex-row items-center justify-between p-8 md:p-12 md:gap-5 gap-10">
        ...
        <div className="flex justify-center  w-full md:w-1/2">
          <img
            ...
            className="rounded-full w-80 h-110 object-cover shadow-xl hover:scale-105 transition-transform duration-300"
          />
        </div>
        ...
        <div className="w-full md:w-1/2 text-center md:text-left ">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-lg mx-auto md:mx-0 mb-8">
            Full Stack Developer | Crafting seamless web experiences with modern
            technologies.
          </p>
